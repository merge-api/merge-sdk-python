...
class Collection(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            collection_type (bool, date, datetime, dict, float, int, list, str, none_type): The collection's type.  * `LIST` - LIST * `PROJECT` - PROJECT. [optional]  # noqa: E501
            parent_collection (str, none_type): The parent collection for this collection.. [optional]  # noqa: E501
            remote_was_deleted (bool): Indicates whether or not this object has been deleted by third party webhooks.. [optional]  # noqa: E501
            access_level (bool, date, datetime, dict, float, int, list, str, none_type): The level of access a User has to the Collection and its sub-objects.  * `PRIVATE` - PRIVATE * `COMPANY` - COMPANY * `PUBLIC` - PUBLIC. [optional]  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        self.collection_type: Union[bool, date, datetime, dict, float, int, list, str, none_type] = kwargs.get("collection_type", None)
        ...
        self.access_level: Union[bool, date, datetime, dict, float, int, list, str, none_type] = kwargs.get("access_level", None)
