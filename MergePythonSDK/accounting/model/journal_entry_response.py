...
class JournalEntryResponse(ModelNormal):
    ...
    def __init__(self, model, warnings, errors, *args, **kwargs):  # noqa: E501
        ...
        self.model: Union["JournalEntry", {"accounting_period": "AccountingPeriod", "company": "CompanyInfo", "lines": "JournalLine", "payments": "Payment", "tracking_categories": "TrackingCategory"}] = model
