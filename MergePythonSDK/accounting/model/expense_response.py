...
class ExpenseResponse(ModelNormal):
    ...
    def __init__(self, model, warnings, errors, *args, **kwargs):  # noqa: E501
        ...
        self.model: Union["Expense", {"account": "Account", "accounting_period": "AccountingPeriod", "company": "CompanyInfo", "contact": "Contact", "tracking_categories": "TrackingCategory"}] = model
