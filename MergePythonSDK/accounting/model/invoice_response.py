...
class InvoiceResponse(ModelNormal):
    ...
    def __init__(self, model, warnings, errors, *args, **kwargs):  # noqa: E501
        ...
        self.model: Union["Invoice", {"accounting_period": "AccountingPeriod", "company": "CompanyInfo", "contact": "Contact", "line_items": "InvoiceLineItem", "payments": "Payment", "purchase_orders": "PurchaseOrder", "tracking_categories": "TrackingCategory"}] = model
