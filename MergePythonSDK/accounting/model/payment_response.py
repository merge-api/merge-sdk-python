...
class PaymentResponse(ModelNormal):
    ...
    def __init__(self, model, warnings, errors, *args, **kwargs):  # noqa: E501
        ...
        self.model: Union["Payment", {"account": "Account", "accounting_period": "AccountingPeriod", "applied_to_lines": "PaymentLineItem", "company": "CompanyInfo", "contact": "Contact", "tracking_categories": "TrackingCategory"}] = model
