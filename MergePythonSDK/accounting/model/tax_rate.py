...
class TaxRate(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        self.total_tax_rate: Optional[float, none_type] = kwargs.get("total_tax_rate", None)
        self.effective_tax_rate: Optional[float, none_type] = kwargs.get("effective_tax_rate", None)
