...
def lazy_import():
    ...
    from MergePythonSDK.accounting.model.invoice_status_enum import InvoiceStatusEnum
...
class Invoice(ModelNormal):
    ...
    def openapi_types():
        ...
        defined_types = {
            ...
            'status': (InvoiceStatusEnum, str, none_type,),
            ...
            'accounting_period': (str, none_type, none_type,),  # noqa: E501
            'purchase_orders': ([str, none_type], none_type,),  # noqa: E501
        ...
        expands_types = {"accounting_period": "AccountingPeriod", "company": "CompanyInfo", "contact": "Contact", "line_items": "InvoiceLineItem", "payments": "Payment", "purchase_orders": "PurchaseOrder", "tracking_categories": "TrackingCategory"}
    ...
    attribute_map = {
        ...
        'purchase_orders': 'purchase_orders',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            status (bool, date, datetime, dict, float, int, list, str, none_type): The status of the invoice.  * `PAID` - PAID * `DRAFT` - DRAFT * `SUBMITTED` - SUBMITTED * `PARTIALLY_PAID` - PARTIALLY_PAID * `OPEN` - OPEN * `VOID` - VOID. [optional]  # noqa: E501
            ...
            accounting_period (str, none_type): The accounting period that the Invoice was generated in.. [optional]  # noqa: E501
            purchase_orders ([str, none_type]): [optional]  # noqa: E501
        ...
        self.purchase_orders = kwargs.get("purchase_orders", None)
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        self.accounting_period: Union[str, none_type] = kwargs.get("accounting_period", None)
        self.purchase_orders: Union[List[str, none_type]] = kwargs.get("purchase_orders", list())
