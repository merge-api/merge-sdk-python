...
**gender** | **bool, date, datetime, dict, float, int, list, str, none_type** | The employee&#39;s gender. | [optional] 
**ethnicity** | **bool, date, datetime, dict, float, int, list, str, none_type** | The employee&#39;s ethnicity. | [optional] 
**marital_status** | **bool, date, datetime, dict, float, int, list, str, none_type** | The employee&#39;s marital status. | [optional] 
...
**employment_status** | **bool, date, datetime, dict, float, int, list, str, none_type** | The employment status of the employee. | [optional] 
