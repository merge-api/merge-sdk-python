...
**run_state** | **bool, dict, float, int, list, str, none_type** | The state of the payroll run | [optional] 
**run_type** | **bool, dict, float, int, list, str, none_type** | The type of the payroll run | [optional] 
