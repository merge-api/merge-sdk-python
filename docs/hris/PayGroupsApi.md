...
# **pay_groups_list**
> PaginatedPayGroupList pay_groups_list(x_account_token)
...
with MergePythonSDK.hris.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.pay_groups_list(x_account_token)
        pprint(api_response)
    ...
    # and optional values
    try:
        api_response = api_instance.pay_groups_list(x_account_token, created_after=created_after, created_before=created_before, cursor=cursor, include_deleted_data=include_deleted_data, include_remote_data=include_remote_data, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_id=remote_id)
        pprint(api_response)
    except MergePythonSDK.hris.ApiException as e:
        print("Exception when calling PayGroupsApi->pay_groups_list: %s\n" % e)
```
...
# **pay_groups_retrieve**
> PayGroup pay_groups_retrieve(x_account_token, id)
...
with MergePythonSDK.hris.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.pay_groups_retrieve(x_account_token, id)
        pprint(api_response)
    except MergePythonSDK.hris.ApiException as e:
    ...
    # and optional values
    try:
        api_response = api_instance.pay_groups_retrieve(x_account_token, id, include_remote_data=include_remote_data)
        pprint(api_response)
    except MergePythonSDK.hris.ApiException as e:
        print("Exception when calling PayGroupsApi->pay_groups_retrieve: %s\n" % e)
```
