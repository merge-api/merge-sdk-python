...
**status** | **bool, date, datetime, dict, float, int, list, str, none_type** | The tracking category&#39;s status. | [optional] 
**category_type** | **bool, date, datetime, dict, float, int, list, str, none_type** | The tracking category’s type. | [optional] 
**parent_category** | **str, none_type** |  | [optional] 
