...
> PaginatedTrackingCategoryList tracking_categories_list(x_account_token)
...
with MergePythonSDK.accounting.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.tracking_categories_list(x_account_token)
        pprint(api_response)
    ...
    # and optional values
    try:
        api_response = api_instance.tracking_categories_list(x_account_token, created_after=created_after, created_before=created_before, cursor=cursor, include_deleted_data=include_deleted_data, include_remote_data=include_remote_data, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_fields=remote_fields, remote_id=remote_id)
        pprint(api_response)
    except MergePythonSDK.accounting.ApiException as e:
        print("Exception when calling TrackingCategoriesApi->tracking_categories_list: %s\n" % e)
```
...
> TrackingCategory tracking_categories_retrieve(x_account_token, id)
...
with MergePythonSDK.accounting.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.tracking_categories_retrieve(x_account_token, id)
        pprint(api_response)
    except MergePythonSDK.accounting.ApiException as e:
    ...
    # and optional values
    try:
        api_response = api_instance.tracking_categories_retrieve(x_account_token, id, include_remote_data=include_remote_data, remote_fields=remote_fields)
        pprint(api_response)
    except MergePythonSDK.accounting.ApiException as e:
        print("Exception when calling TrackingCategoriesApi->tracking_categories_retrieve: %s\n" % e)
```
