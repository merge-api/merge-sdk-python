...
**status** | **bool, date, datetime, dict, float, int, list, str, none_type** | The credit note&#39;s status. | [optional] 
...
**currency** | **bool, date, datetime, dict, float, int, list, str, none_type** | The credit note&#39;s currency. | [optional] 
