...
# **accounts_create**
> CRMAccountResponse accounts_create(crm_account_endpoint_request)
...
with MergePythonSDK.crm.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.accounts_create(crm_account_endpoint_request)
        pprint(api_response)
    ...
    # and optional values
    try:
        api_response = api_instance.accounts_create(crm_account_endpoint_request, is_debug_mode=is_debug_mode, run_async=run_async)
        pprint(api_response)
    except MergePythonSDK.crm.ApiException as e:
        print("Exception when calling AccountsApi->accounts_create: %s\n" % e)
```
...
# **accounts_list**
> PaginatedAccountList accounts_list()
...
> MetaResponse accounts_meta_patch_retrieve(id)
...
with MergePythonSDK.crm.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.accounts_meta_patch_retrieve(id)
        pprint(api_response)
    except MergePythonSDK.crm.ApiException as e:
        print("Exception when calling AccountsApi->accounts_meta_patch_retrieve: %s\n" % e)
```
...
> MetaResponse accounts_meta_post_retrieve()
...
with MergePythonSDK.crm.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.accounts_meta_post_retrieve()
        pprint(api_response)
    except MergePythonSDK.crm.ApiException as e:
...
> CRMAccountResponse accounts_partial_update(id, patched_crm_account_endpoint_request)
...
with MergePythonSDK.crm.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.accounts_partial_update(id, patched_crm_account_endpoint_request)
        pprint(api_response)
    except MergePythonSDK.crm.ApiException as e:
    ...
    # and optional values
    try:
        api_response = api_instance.accounts_partial_update(id, patched_crm_account_endpoint_request, is_debug_mode=is_debug_mode, run_async=run_async)
        pprint(api_response)
    except MergePythonSDK.crm.ApiException as e:
        print("Exception when calling AccountsApi->accounts_partial_update: %s\n" % e)
```
...
> PaginatedRemoteFieldClassList accounts_remote_field_classes_list()
...
with MergePythonSDK.crm.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.accounts_remote_field_classes_list(cursor=cursor, include_deleted_data=include_deleted_data, include_remote_data=include_remote_data, include_remote_fields=include_remote_fields, page_size=page_size)
        pprint(api_response)
    except MergePythonSDK.crm.ApiException as e:
        print("Exception when calling AccountsApi->accounts_remote_field_classes_list: %s\n" % e)
```
...
with MergePythonSDK.crm.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.accounts_retrieve(id, expand=expand, include_remote_data=include_remote_data, include_remote_fields=include_remote_fields)
        pprint(api_response)
    except MergePythonSDK.crm.ApiException as e:
        print("Exception when calling AccountsApi->accounts_retrieve: %s\n" % e)
```
