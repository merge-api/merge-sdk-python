...
# **engagements_create**
> EngagementResponse engagements_create(x_account_token, engagement_endpoint_request)
...
with MergePythonSDK.crm.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.engagements_create(x_account_token, engagement_endpoint_request)
        pprint(api_response)
    ...
    # and optional values
    try:
        api_response = api_instance.engagements_create(x_account_token, engagement_endpoint_request, is_debug_mode=is_debug_mode, run_async=run_async)
        pprint(api_response)
    except MergePythonSDK.crm.ApiException as e:
        print("Exception when calling EngagementsApi->engagements_create: %s\n" % e)
```
...
# **engagements_list**
> PaginatedEngagementList engagements_list(x_account_token)
...
with MergePythonSDK.crm.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.engagements_list(x_account_token)
        pprint(api_response)
    except MergePythonSDK.crm.ApiException as e:
    ...
    # and optional values
    try:
        api_response = api_instance.engagements_list(x_account_token, created_after=created_after, created_before=created_before, cursor=cursor, expand=expand, include_deleted_data=include_deleted_data, include_remote_data=include_remote_data, include_remote_fields=include_remote_fields, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_id=remote_id)
        pprint(api_response)
    except MergePythonSDK.crm.ApiException as e:
        print("Exception when calling EngagementsApi->engagements_list: %s\n" % e)
```
...
with MergePythonSDK.crm.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.engagements_meta_patch_retrieve(x_account_token, id)
        pprint(api_response)
    except MergePythonSDK.crm.ApiException as e:
...
with MergePythonSDK.crm.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.engagements_meta_post_retrieve(x_account_token)
        pprint(api_response)
    except MergePythonSDK.crm.ApiException as e:
...
> EngagementResponse engagements_partial_update(x_account_token, id, patched_engagement_endpoint_request)
...
with MergePythonSDK.crm.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.engagements_partial_update(x_account_token, id, patched_engagement_endpoint_request)
        pprint(api_response)
    except MergePythonSDK.crm.ApiException as e:
    ...
    # and optional values
    try:
        api_response = api_instance.engagements_partial_update(x_account_token, id, patched_engagement_endpoint_request, is_debug_mode=is_debug_mode, run_async=run_async)
        pprint(api_response)
    except MergePythonSDK.crm.ApiException as e:
        print("Exception when calling EngagementsApi->engagements_partial_update: %s\n" % e)
```
...
> PaginatedRemoteFieldClassList engagements_remote_field_classes_list(x_account_token)
...
with MergePythonSDK.crm.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.engagements_remote_field_classes_list(x_account_token)
        pprint(api_response)
    except MergePythonSDK.crm.ApiException as e:
    ...
    # and optional values
    try:
        api_response = api_instance.engagements_remote_field_classes_list(x_account_token, cursor=cursor, include_deleted_data=include_deleted_data, include_remote_data=include_remote_data, include_remote_fields=include_remote_fields, page_size=page_size)
        pprint(api_response)
    except MergePythonSDK.crm.ApiException as e:
        print("Exception when calling EngagementsApi->engagements_remote_field_classes_list: %s\n" % e)
```
...
> Engagement engagements_retrieve(x_account_token, id)
...
with MergePythonSDK.crm.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.engagements_retrieve(x_account_token, id)
        pprint(api_response)
    except MergePythonSDK.crm.ApiException as e:
    ...
    # and optional values
    try:
        api_response = api_instance.engagements_retrieve(x_account_token, id, expand=expand, include_remote_data=include_remote_data, include_remote_fields=include_remote_fields)
        pprint(api_response)
    except MergePythonSDK.crm.ApiException as e:
        print("Exception when calling EngagementsApi->engagements_retrieve: %s\n" % e)
```
